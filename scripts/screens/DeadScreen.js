(function (Ω) {
	...
	var DeadScreen = Ω.Screen.extend({
		...
		render: function (gfx) {
			...
			if (game.numDeaths === 1) {
				c.fillText("You have died of old age.", gfx.w * 0.4, gfx.h * (0.4 + off));
			...
			if (!game.seenCarl && game.numDeaths > 2) {
				c.fillText("There is more to this, you know.", gfx.w * 0.4, gfx.h * (0.4 + off));
				c.fillText("If you move fast, and stay right.", gfx.w * 0.4, gfx.h * (0.44+ off));
				c.fillText("You can visit Carl Sagan.", gfx.w * 0.4, gfx.h * (0.51+ off));
				c.fillText("He'll tell you what to do.", gfx.w * 0.4, gfx.h * (0.58 + off));
				return;
			}

			c.fillText("You have died of old age. Again.", gfx.w * 0.4, gfx.h * (0.4 + off));
